...
pub fn aa_roll_table(aa: u8, level: usize, k: usize) -> u64 {
    let rot_31 = if k < 31 {k} else {k % 31};
    let rot_33 = if k < 33 {k} else {k % 33};
    let seed_left = match level {
        1 => AA_SEED_LEFT_31BITS_ROLL_TABLE[aa][rot_31],
        2 => todo!(),
        3 => todo!(),
        _ => panic!("Invalid level"),
    };
    let seed_right = match level {
        1 => AA_SEED_RIGHT_33BITS_ROLL_TABLE[aa][rot_33],
        2 => todo!(),
        3 => todo!(),
        _ => panic!("Invalid level"),
    };
...
pub fn AA_SEED_RIGHT_33BITS_ROLL_TABLE(aa: u8, pos: usize) -> u64 {
    match aa {
        ...
        "C" | "c" => AA_SEED_C_RIGHT_33BITS_ROLL_TABLE[pos],
        "D" | "d" => AA_SEED_D_RIGHT_33BITS_ROLL_TABLE[pos],
        "E" | "e" => AA_SEED_E_RIGHT_33BITS_ROLL_TABLE[pos],
        "F" | "f" => AA_SEED_F_RIGHT_33BITS_ROLL_TABLE[pos],
        "G" | "h" => AA_SEED_G_RIGHT_33BITS_ROLL_TABLE[pos],
        "H" | "h" => AA_SEED_H_RIGHT_33BITS_ROLL_TABLE[pos],
        "I" | "i" => AA_SEED_I_RIGHT_33BITS_ROLL_TABLE[pos],
        "K" | "k" => AA_SEED_K_RIGHT_33BITS_ROLL_TABLE[pos],
...
pub const AA_SEED_D: u64 = 0xe8c583296b03c7af;
pub const AA_SEED_E: u64 = 0x6d8186850ee2f67;
pub const AA_SEED_F: u64 = 0x921e1da156b717ad;
pub const AA_SEED_G: u64 = 0xa70dc450015e3ffe;
pub const AA_SEED_H: u64 = 0x2242263a9d5638ff;
pub const AA_SEED_I: u64 = 0x2469ca06d519cdef;
pub const AA_SEED_K: u64 = 0xd4e7f06ac0593d3b;
pub const AA_SEED_L: u64 = 0xa5e19c0b1b40a97f;
pub const AA_SEED_M: u64 = 0xfab3d6d4dd74c000;
pub const AA_SEED_N: u64 = 0x4b363f2cf7bc5200;
pub const AA_SEED_P: u64 = 0x21ac8af2adb65ce4;
pub const AA_SEED_Q: u64 = 0x1d3baae9ab7cd800;
pub const AA_SEED_R: u64 = 0x49015253a9dbedf;
pub const AA_SEED_S: u64 = 0x5bf1f1d7ae699000;
pub const AA_SEED_T: u64 = 0xdb0c63dd7282cf90;
pub const AA_SEED_V: u64 = 0x7df64ddf78874000;
pub const AA_SEED_W: u64 = 0xee9e700cae6aa279;
pub const AA_SEED_Y: u64 = 0x5852ffb781a97610;
pub const AA_SEED__: u64 = 0x0000000000000000;

pub const AA_SEED_TABLE: [u64; 256] = [
...
pub const AA_SEED_A_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
  ...
  pub const AA_SEED_A_LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
  ...
  pub const AA_SEED_C_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
  ...
  pub const AA_SEED_C_LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
  ...
  pub const AA_SEED_D_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
  ...
  pub const AA_SEED_D_LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
  ...
  pub const AA_SEED_E_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
  ...
  pub const AA_SEED_E_LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
  ...
  pub const AA_SEED_F_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
  ...
  pub const AA_SEED_F_LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
  ...
  pub const AA_SEED_G_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
  ...
  pub const AA_SEED_G_LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
  ...
  pub const AA_SEED_H_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
  ...
  pub const AA_SEED_H_LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
  ...
  pub const AA_SEED_I_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
  ...
  pub const AA_SEED_I_LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
  ...
  pub const AA_SEED_K_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
  ...
  pub const AA_SEED_K_LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
  ...
  pub const AA_SEED_L_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
  ...
  pub const AA_SEED_L_LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
  ...
  pub const AA_SEED_M_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
  ...
  pub const AA_SEED_M_LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
  ...
  pub const AA_SEED_N_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
  ...
  pub const AA_SEED_N_LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
  ...
  pub const AA_SEED_P_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
  ...
  pub const AA_SEED_P_LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
  ...
  pub const AA_SEED_Q_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
  ...
  pub const AA_SEED_Q_LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
  ...
  pub const AA_SEED_R_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
  ...
  pub const AA_SEED_R_LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
  ...
  pub const AA_SEED_S_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
  ...
  pub const AA_SEED_S_LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
  ...
  pub const AA_SEED_T_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
  ...
  pub const AA_SEED_T_LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
  ...
  pub const AA_SEED_V_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
  ...
  pub const AA_SEED_V_LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
  ...
  pub const AA_SEED_W_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
  ...
  pub const AA_SEED_W_LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
  ...
  pub const AA_SEED_Y_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
  ...
  pub const AA_SEED_Y_LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
  ...
  pub const AA_SEED___RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
  ...
  pub const AA_SEED___LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
    AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__,
    AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__,
    AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__,
    AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__,
  ...
  pub const AA_SEED_RIGHT_33BITS_ROLL_TABLE: [&[u64; 256]; 256] = [
  ...
  pub const AA_SEED_LEFT_31BITS_ROLL_TABLE: [&[u64; 256]; 256] = [
  ...
  /*
  pub const LEVEL_2_AA_SEED_C___ = 0x1d07fd644abe9962; 
  pub const LEVEL_2_AA_SEED_G___ = 0xf59c50929bdf4360; 
  pub const LEVEL_2_AA_SEED_A___ = 0x6f735c82fe9c6c03; 
  pub const LEVEL_2_AA_SEED_TS__ = 0xe7392f0ba1dbc3b0; 
  pub const LEVEL_2_AA_SEED_N___ = 0x956ddcfcd4b3961f; 
  pub const LEVEL_2_AA_SEED_DE__ = 0x4ec0ef1bac4f5efa; 
  pub const LEVEL_2_AA_SEED_QKR_ = 0x1cd6ca491872ed78; 
  pub const LEVEL_2_AA_SEED_VILM = 0x547ef17894921035; 
  pub const LEVEL_2_AA_SEED_WFY_ = 0x419722edb87bf79f; 
  pub const LEVEL_2_AA_SEED_H___ = 0xdd5cce5bfdc32de1; 
  pub const LEVEL_2_AA_SEED_P___ = 0x90e0c5e0c07d6598; 
  pub const LEVEL_2_AA_SEED_____ = AA_SEED__;          
  
  pub const LEVEL_2_AA_SEED_TABLE[ASCII_SIZE] = {
  ...
  pub const
    LEVEL_2_AA_SEED_C____RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [ 
  ...
  pub const
    LEVEL_2_AA_SEED_C____LEFT_31BITS_ROLL_TABLE: [u64; 31] = [ 
  ...
  pub const
    LEVEL_2_AA_SEED_G____RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [ 
  ...
  pub const
    LEVEL_2_AA_SEED_G____LEFT_31BITS_ROLL_TABLE: [u64; 31] = [ 
  ...
  pub const
    LEVEL_2_AA_SEED_A____RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [ 
  ...
  pub const
    LEVEL_2_AA_SEED_A____LEFT_31BITS_ROLL_TABLE: [u64; 31] = [ 
  ...
  pub const
    LEVEL_2_AA_SEED_TS___RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [ 
  ...
  pub const
    LEVEL_2_AA_SEED_TS___LEFT_31BITS_ROLL_TABLE: [u64; 31] = [ 
  ...
  pub const
    LEVEL_2_AA_SEED_N____RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [ 
  ...
  pub const
    LEVEL_2_AA_SEED_N____LEFT_31BITS_ROLL_TABLE: [u64; 31] = [ 
  ...
  pub const
    LEVEL_2_AA_SEED_DE___RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [ 
  ...
  pub const
    LEVEL_2_AA_SEED_DE___LEFT_31BITS_ROLL_TABLE: [u64; 31] = [ 
  ...
  pub const
    LEVEL_2_AA_SEED_QKR__RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [ 
  ...
  pub const
    LEVEL_2_AA_SEED_QKR__LEFT_31BITS_ROLL_TABLE: [u64; 31] = [ 
  ...
  pub const LEVEL_2_AA_SEED_VILM_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
  ...
  pub const LEVEL_2_AA_SEED_VILM_LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
  ...
  pub const
    LEVEL_2_AA_SEED_WFY__RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [ 
  ...
  pub const
    LEVEL_2_AA_SEED_WFY__LEFT_31BITS_ROLL_TABLE: [u64; 31] = [ 
  ...
  pub const
    LEVEL_2_AA_SEED_H____RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [ 
  ...
  pub const
    LEVEL_2_AA_SEED_H____LEFT_31BITS_ROLL_TABLE: [u64; 31] = [ 
  ...
  pub const
    LEVEL_2_AA_SEED_P____RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [ 
  ...
  pub const
    LEVEL_2_AA_SEED_P____LEFT_31BITS_ROLL_TABLE: [u64; 31] = [ 
  ...
  pub const LEVEL_3_AA_SEED_C___ = 0x5713e4c10cebbfa3; 
  pub const LEVEL_3_AA_SEED_G___ = 0xbe084b869537379b; 
  pub const LEVEL_3_AA_SEED_ATS_ = 0x985fd9efa0fe5b82; 
  pub const LEVEL_3_AA_SEED_NDE_ = 0x9aca6c4f4ef69df0; 
  pub const LEVEL_3_AA_SEED_QKR_ = 0x917de473b721df0e; 
  pub const LEVEL_3_AA_SEED_VILM = 0x37cdd84aa07c5bd7;
  pub const LEVEL_3_AA_SEED_WFY_ = 0x51a7955f1a67a896; 
  pub const LEVEL_3_AA_SEED_H___ = 0x1d2a0ba493708fbf; 
  pub const LEVEL_3_AA_SEED_P___ = 0xfe4c47da16611245; 
  pub const LEVEL_3_AA_SEED_____ = AA_SEED__;          
  
  pub const LEVEL_3_AA_SEED_TABLE[ASCII_SIZE] = {
  ...
  pub const
    LEVEL_3_AA_SEED_C____RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [ 
  ...
  pub const
    LEVEL_3_AA_SEED_C____LEFT_31BITS_ROLL_TABLE: [u64; 31] = [ 
  ...
  pub const
    LEVEL_3_AA_SEED_G____RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [ 
  ...
  pub const
    LEVEL_3_AA_SEED_G____LEFT_31BITS_ROLL_TABLE: [u64; 31] = [ 
  ...
  pub const
    LEVEL_3_AA_SEED_ATS__RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [ 
  ...
  pub const
    LEVEL_3_AA_SEED_ATS__LEFT_31BITS_ROLL_TABLE: [u64; 31] = [ 
  ...
  pub const
    LEVEL_3_AA_SEED_NDE__RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [ 
  ...
  pub const
    LEVEL_3_AA_SEED_NDE__LEFT_31BITS_ROLL_TABLE: [u64; 31] = [ 
  ...
  pub const
    LEVEL_3_AA_SEED_QKR__RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [ 
  ...
  pub const
    LEVEL_3_AA_SEED_QKR__LEFT_31BITS_ROLL_TABLE: [u64; 31] = [ 
  ...
  pub const LEVEL_3_AA_SEED_VILM_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
  ...
  pub const LEVEL_3_AA_SEED_VILM_LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
  ...
  pub const
    LEVEL_3_AA_SEED_WFY__RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [ 
  ...
  pub const
    LEVEL_3_AA_SEED_WFY__LEFT_31BITS_ROLL_TABLE: [u64; 31] = [ 
  ...
  pub const
    LEVEL_3_AA_SEED_H____RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [ 
  ...
  pub const
    LEVEL_3_AA_SEED_H____LEFT_31BITS_ROLL_TABLE: [u64; 31] = [ 
  ...
  pub const
    LEVEL_3_AA_SEED_P____RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [ 
  ...
  pub const
    LEVEL_3_AA_SEED_P____LEFT_31BITS_ROLL_TABLE: [u64; 31] = [ 
