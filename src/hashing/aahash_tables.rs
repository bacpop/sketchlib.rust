...
// TODO: maybe a trait for the levels would hit the spot here

fn aa_roll_table(aa: u8, level: usize, k: usize) -> u64 {
    let rot_31 = if k < 31 {k} else {k % 31};
    let rot_33 = if k < 33 {k} else {k % 33};
    let seed_left = match level {
        1 => AA_SEED_LEFT_31BITS_ROLL_TABLE[aa as usize][rot_31],
        2 => todo!(),
        3 => todo!(),
        _ => panic!("Invalid level"),
    };
    let seed_right = match level {
        1 => AA_SEED_RIGHT_33BITS_ROLL_TABLE[aa as usize][rot_33],
        2 => todo!(),
        3 => todo!(),
        _ => panic!("Invalid level"),
    };
...
const AA_SEED_A_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
  ...
  const LEVEL_2_AA_SEED______RIGHT_33BITS_ROLL_TABLE: [u64; 33] =
    AA_SEED___RIGHT_33BITS_ROLL_TABLE;
  const LEVEL_2_AA_SEED______LEFT_31BITS_ROLL_TABLE: [u64; 31] =
    AA_SEED___LEFT_31BITS_ROLL_TABLE;
  ...
  const LEVEL_3_AA_SEED______RIGHT_33BITS_ROLL_TABLE: [u64; 33] =
    AA_SEED___RIGHT_33BITS_ROLL_TABLE;
  const LEVEL_3_AA_SEED______LEFT_31BITS_ROLL_TABLE: [u64; 31] =
    AA_SEED___LEFT_31BITS_ROLL_TABLE;
