...
impl AaLevel {
    pub fn aa_seed_table(&self, aa: u8) -> u64 {
        match self {
            ...
            AaLevel::Level3 => LEVEL_3_AA_SEED_TABLE[aa as usize],
        }
    }
    ...
    pub fn aa_roll_table(&self, aa: u8, k: usize) -> u64 {
        ...
        match self {
            AaLevel::Level1 => {
                AA_SEED_LEFT_31BITS_ROLL_TABLE[aa as usize][rot_31]
                    | AA_SEED_RIGHT_33BITS_ROLL_TABLE[aa as usize][rot_33]
            }
            AaLevel::Level2 => {
                LEVEL_2_AA_SEED_LEFT_31BITS_ROLL_TABLE[aa as usize][rot_31]
                    | LEVEL_2_AA_SEED_RIGHT_33BITS_ROLL_TABLE[aa as usize][rot_33]
            }
            AaLevel::Level3 => {
                LEVEL_3_AA_SEED_LEFT_31BITS_ROLL_TABLE[aa as usize][rot_31]
                    | LEVEL_3_AA_SEED_RIGHT_33BITS_ROLL_TABLE[aa as usize][rot_33]
            }
        }
    }
}

const AA_SEED_A: u64 = 0xf56d6192468323df;
const AA_SEED_C: u64 = 0x9b0b2fd724e1e1d2;
const AA_SEED_D: u64 = 0xe8c583296b03c7af;
const AA_SEED_E: u64 = 0x6d8186850ee2f67;
const AA_SEED_F: u64 = 0x921e1da156b717ad;
const AA_SEED_G: u64 = 0xa70dc450015e3ffe;
const AA_SEED_H: u64 = 0x2242263a9d5638ff;
const AA_SEED_I: u64 = 0x2469ca06d519cdef;
const AA_SEED_K: u64 = 0xd4e7f06ac0593d3b;
const AA_SEED_L: u64 = 0xa5e19c0b1b40a97f;
const AA_SEED_M: u64 = 0xfab3d6d4dd74c000;
const AA_SEED_N: u64 = 0x4b363f2cf7bc5200;
const AA_SEED_P: u64 = 0x21ac8af2adb65ce4;
const AA_SEED_Q: u64 = 0x1d3baae9ab7cd800;
const AA_SEED_R: u64 = 0x49015253a9dbedf;
const AA_SEED_S: u64 = 0x5bf1f1d7ae699000;
const AA_SEED_T: u64 = 0xdb0c63dd7282cf90;
const AA_SEED_V: u64 = 0x7df64ddf78874000;
const AA_SEED_W: u64 = 0xee9e700cae6aa279;
const AA_SEED_Y: u64 = 0x5852ffb781a97610;
const AA_SEED__: u64 = 0x0000000000000000;

const AA_SEED_TABLE: [u64; 256] = [
    ...
    AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__,
    AA_SEED__, // 56..63
    AA_SEED__, AA_SEED_A, AA_SEED__, AA_SEED_C, AA_SEED_D, AA_SEED_E, AA_SEED_F,
    AA_SEED_G, // 64..71
    AA_SEED_H, AA_SEED_I, AA_SEED__, AA_SEED_K, AA_SEED_L, AA_SEED_M, AA_SEED_N,
    AA_SEED__, // 72..79
    AA_SEED_P, AA_SEED_Q, AA_SEED_R, AA_SEED_S, AA_SEED_T, AA_SEED__, AA_SEED_V,
    AA_SEED_W, // 80..87
    AA_SEED__, AA_SEED_Y, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__,
    AA_SEED__, // 88..95
    AA_SEED__, AA_SEED_A, AA_SEED__, AA_SEED_C, AA_SEED_D, AA_SEED_E, AA_SEED_F,
    AA_SEED_G, // 96..103
    AA_SEED_H, AA_SEED_I, AA_SEED__, AA_SEED_K, AA_SEED_L, AA_SEED_M, AA_SEED_N,
...
const AA_SEED_A_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
    0x468323df,
    0x8d0647be,
    0x11a0c8f7c,
    0x34191ef9,
...
const AA_SEED_A_LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
    0xf56d619200000000,
    0xeadac32600000000,
    0xd5b5864e00000000,
    0xab6b0c9e00000000,
...
const AA_SEED_C_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
    0x124e1e1d2,
    0x49c3c3a5,
    0x9387874a,
    0x1270f0e94,
...
const AA_SEED_C_LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
    0x9b0b2fd600000000,
    0x36165fae00000000,
    0x6c2cbf5c00000000,
    0xd8597eb800000000,
...
const AA_SEED_D_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
    0x16b03c7af,
    0xd6078f5f,
    0x1ac0f1ebe,
    0x1581e3d7d,
...
const AA_SEED_D_LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
    0xe8c5832800000000,
    0xd18b065200000000,
    0xa3160ca600000000,
    0x462c194e00000000,
...
const AA_SEED_E_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
    0x50ee2f67,
    0xa1dc5ece,
    0x143b8bd9c,
    0x87717b39,
...
const AA_SEED_E_LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
    0x6d8186800000000,
    0xdb030d000000000,
    0x1b6061a000000000,
    0x36c0c34000000000,
...
const AA_SEED_F_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
    0x156b717ad,
    0xad6e2f5b,
    0x15adc5eb6,
    0xb5b8bd6d,
...
const AA_SEED_F_LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
    0x921e1da000000000,
    0x243c3b4200000000,
    0x4878768400000000,
    0x90f0ed0800000000,
...
const AA_SEED_G_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
    0x15e3ffe,
    0x2bc7ffc,
    0x578fff8,
    0xaf1fff0,
...
const AA_SEED_G_LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
    0xa70dc45000000000,
    0x4e1b88a200000000,
    0x9c37114400000000,
    0x386e228a00000000,
...
const AA_SEED_H_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
    0x9d5638ff,
    0x13aac71fe,
    0x7558e3fd,
    0xeab1c7fa,
...
const AA_SEED_H_LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
    0x2242263a00000000,
    0x44844c7400000000,
    0x890898e800000000,
    0x121131d200000000,
...
const AA_SEED_I_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
    0xd519cdef,
    0x1aa339bde,
    0x1546737bd,
    0xa8ce6f7b,
...
const AA_SEED_I_LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
    0x2469ca0600000000,
    0x48d3940c00000000,
    0x91a7281800000000,
    0x234e503200000000,
...
const AA_SEED_K_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
    0xc0593d3b,
    0x180b27a76,
    0x10164f4ed,
    0x2c9e9db,
...
const AA_SEED_K_LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
    0xd4e7f06a00000000,
    0xa9cfe0d600000000,
    0x539fc1ae00000000,
    0xa73f835c00000000,
...
const AA_SEED_L_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
    0x11b40a97f,
    0x368152ff,
    0x6d02a5fe,
    0xda054bfc,
...
const AA_SEED_L_LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
    0xa5e19c0a00000000,
    0x4bc3381600000000,
    0x9786702c00000000,
    0x2f0ce05a00000000,
...
const AA_SEED_M_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
    0xdd74c000,
    0x1bae98000,
    0x175d30001,
    0xeba60003,
...
const AA_SEED_M_LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
    0xfab3d6d400000000,
    0xf567adaa00000000,
    0xeacf5b5600000000,
    0xd59eb6ae00000000,
...
const AA_SEED_N_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
    0xf7bc5200,
    0x1ef78a400,
    0x1def14801,
    0x1bde29003,
...
const AA_SEED_N_LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
    0x4b363f2c00000000,
    0x966c7e5800000000,
    0x2cd8fcb200000000,
    0x59b1f96400000000,
...
const AA_SEED_P_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
    0xadb65ce4,
    0x15b6cb9c8,
    0xb6d97391,
    0x16db2e722,
...
const AA_SEED_P_LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
    0x21ac8af200000000,
    0x435915e400000000,
    0x86b22bc800000000,
    0xd64579200000000,
...
const AA_SEED_Q_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
    0x1ab7cd800,
    0x156f9b001,
    0xadf36003,
    0x15be6c006,
...
const AA_SEED_Q_LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
    0x1d3baae800000000,
    0x3a7755d000000000,
    0x74eeaba000000000,
    0xe9dd574000000000,
...
const AA_SEED_R_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
    0x13a9dbedf,
    0x753b7dbf,
    0xea76fb7e,
    0x1d4edf6fc,
...
const AA_SEED_R_LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
    0x490152400000000,
    0x9202a4800000000,
    0x1240549000000000,
    0x2480a92000000000,
...
const AA_SEED_S_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
    0x1ae699000,
    0x15cd32001,
    0xb9a64003,
    0x1734c8006,
...
const AA_SEED_S_LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
    0x5bf1f1d600000000,
    0xb7e3e3ac00000000,
    0x6fc7c75a00000000,
    0xdf8f8eb400000000,
...
const AA_SEED_T_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
    0x17282cf90,
    0xe5059f21,
    0x1ca0b3e42,
    0x194167c85,
...
const AA_SEED_T_LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
    0xdb0c63dc00000000,
    0xb618c7ba00000000,
    0x6c318f7600000000,
    0xd8631eec00000000,
...
const AA_SEED_V_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
    0x178874000,
    0xf10e8001,
    0x1e21d0002,
    0x1c43a0005,
...
const AA_SEED_V_LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
    0x7df64dde00000000,
    0xfbec9bbc00000000,
    0xf7d9377a00000000,
    0xefb26ef600000000,
...
const AA_SEED_W_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
    0xae6aa279,
    0x15cd544f2,
    0xb9aa89e5,
    0x1735513ca,
...
const AA_SEED_W_LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
    0xee9e700c00000000,
    0xdd3ce01a00000000,
    0xba79c03600000000,
    0x74f3806e00000000,
...
const AA_SEED_Y_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
    0x181a97610,
    0x10352ec21,
    0x6a5d843,
    0xd4bb086,
...
const AA_SEED_Y_LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
    0x5852ffb600000000,
    0xb0a5ff6c00000000,
    0x614bfeda00000000,
    0xc297fdb400000000,
...
const AA_SEED___RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
    AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__,
    AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__,
    AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__,
    AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__,
    AA_SEED__,
];
const AA_SEED___LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
    AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__,
    AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__,
    AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__,
    AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__, AA_SEED__,
...
const AA_SEED_RIGHT_33BITS_ROLL_TABLE: [&[u64; 33]; 256] = [
    ...
    &AA_SEED___RIGHT_33BITS_ROLL_TABLE,
    &AA_SEED_A_RIGHT_33BITS_ROLL_TABLE,
    &AA_SEED___RIGHT_33BITS_ROLL_TABLE,
    &AA_SEED_C_RIGHT_33BITS_ROLL_TABLE,
    &AA_SEED_D_RIGHT_33BITS_ROLL_TABLE,
    &AA_SEED_E_RIGHT_33BITS_ROLL_TABLE,
    &AA_SEED_F_RIGHT_33BITS_ROLL_TABLE,
    &AA_SEED_G_RIGHT_33BITS_ROLL_TABLE, // 64..71
    &AA_SEED_H_RIGHT_33BITS_ROLL_TABLE,
    &AA_SEED_I_RIGHT_33BITS_ROLL_TABLE,
    &AA_SEED___RIGHT_33BITS_ROLL_TABLE,
    &AA_SEED_K_RIGHT_33BITS_ROLL_TABLE,
    &AA_SEED_L_RIGHT_33BITS_ROLL_TABLE,
    &AA_SEED_M_RIGHT_33BITS_ROLL_TABLE,
    &AA_SEED_N_RIGHT_33BITS_ROLL_TABLE,
    &AA_SEED___RIGHT_33BITS_ROLL_TABLE, // 72..79
    &AA_SEED_P_RIGHT_33BITS_ROLL_TABLE,
    &AA_SEED_Q_RIGHT_33BITS_ROLL_TABLE,
    &AA_SEED_R_RIGHT_33BITS_ROLL_TABLE,
    &AA_SEED_S_RIGHT_33BITS_ROLL_TABLE,
    &AA_SEED_T_RIGHT_33BITS_ROLL_TABLE,
    &AA_SEED___RIGHT_33BITS_ROLL_TABLE,
    &AA_SEED_V_RIGHT_33BITS_ROLL_TABLE,
    &AA_SEED_W_RIGHT_33BITS_ROLL_TABLE, // 80..87
    &AA_SEED___RIGHT_33BITS_ROLL_TABLE,
    &AA_SEED_Y_RIGHT_33BITS_ROLL_TABLE,
    &AA_SEED___RIGHT_33BITS_ROLL_TABLE,
    &AA_SEED___RIGHT_33BITS_ROLL_TABLE,
    &AA_SEED___RIGHT_33BITS_ROLL_TABLE,
    &AA_SEED___RIGHT_33BITS_ROLL_TABLE,
...
const AA_SEED_LEFT_31BITS_ROLL_TABLE: [&[u64; 31]; 256] = [
    ...
    &AA_SEED___LEFT_31BITS_ROLL_TABLE,
    &AA_SEED_A_LEFT_31BITS_ROLL_TABLE,
    &AA_SEED___LEFT_31BITS_ROLL_TABLE,
    &AA_SEED_C_LEFT_31BITS_ROLL_TABLE,
    &AA_SEED_D_LEFT_31BITS_ROLL_TABLE,
    &AA_SEED_E_LEFT_31BITS_ROLL_TABLE,
    &AA_SEED_F_LEFT_31BITS_ROLL_TABLE,
    &AA_SEED_G_LEFT_31BITS_ROLL_TABLE, // 64..71
    &AA_SEED_H_LEFT_31BITS_ROLL_TABLE,
    &AA_SEED_I_LEFT_31BITS_ROLL_TABLE,
    &AA_SEED___LEFT_31BITS_ROLL_TABLE,
    &AA_SEED_K_LEFT_31BITS_ROLL_TABLE,
    &AA_SEED_L_LEFT_31BITS_ROLL_TABLE,
    &AA_SEED_M_LEFT_31BITS_ROLL_TABLE,
    &AA_SEED_N_LEFT_31BITS_ROLL_TABLE,
    &AA_SEED___LEFT_31BITS_ROLL_TABLE, // 72..79
    &AA_SEED_P_LEFT_31BITS_ROLL_TABLE,
    &AA_SEED_Q_LEFT_31BITS_ROLL_TABLE,
    &AA_SEED_R_LEFT_31BITS_ROLL_TABLE,
    &AA_SEED_S_LEFT_31BITS_ROLL_TABLE,
    &AA_SEED_T_LEFT_31BITS_ROLL_TABLE,
    &AA_SEED___LEFT_31BITS_ROLL_TABLE,
    &AA_SEED_V_LEFT_31BITS_ROLL_TABLE,
    &AA_SEED_W_LEFT_31BITS_ROLL_TABLE, // 80..87
    &AA_SEED___LEFT_31BITS_ROLL_TABLE,
    &AA_SEED_Y_LEFT_31BITS_ROLL_TABLE,
    &AA_SEED___LEFT_31BITS_ROLL_TABLE,
    &AA_SEED___LEFT_31BITS_ROLL_TABLE,
    &AA_SEED___LEFT_31BITS_ROLL_TABLE,
    &AA_SEED___LEFT_31BITS_ROLL_TABLE,
...
const LEVEL_2_AA_SEED_C___: u64 = 0x1d07fd644abe9962;
const LEVEL_2_AA_SEED_G___: u64 = 0xf59c50929bdf4360;
const LEVEL_2_AA_SEED_A___: u64 = 0x6f735c82fe9c6c03;
const LEVEL_2_AA_SEED_TS__: u64 = 0xe7392f0ba1dbc3b0;
const LEVEL_2_AA_SEED_N___: u64 = 0x956ddcfcd4b3961f;
const LEVEL_2_AA_SEED_DE__: u64 = 0x4ec0ef1bac4f5efa;
const LEVEL_2_AA_SEED_QKR_: u64 = 0x1cd6ca491872ed78;
const LEVEL_2_AA_SEED_VILM: u64 = 0x547ef17894921035;
const LEVEL_2_AA_SEED_WFY_: u64 = 0x419722edb87bf79f;
const LEVEL_2_AA_SEED_H___: u64 = 0xdd5cce5bfdc32de1;
const LEVEL_2_AA_SEED_P___: u64 = 0x90e0c5e0c07d6598;
const LEVEL_2_AA_SEED_____: u64 = AA_SEED__;

const LEVEL_2_AA_SEED_TABLE: [u64; 256] = [
    LEVEL_2_AA_SEED_____,
    LEVEL_2_AA_SEED_____,
    LEVEL_2_AA_SEED_____,
    LEVEL_2_AA_SEED_____,
    LEVEL_2_AA_SEED_____,
    ...
    LEVEL_2_AA_SEED_____,
    LEVEL_2_AA_SEED_____,
    LEVEL_2_AA_SEED_____, // 56..63
    LEVEL_2_AA_SEED_____,
    LEVEL_2_AA_SEED_A___,
    LEVEL_2_AA_SEED_____,
    LEVEL_2_AA_SEED_C___,
    LEVEL_2_AA_SEED_DE__,
    LEVEL_2_AA_SEED_DE__,
    LEVEL_2_AA_SEED_WFY_,
    LEVEL_2_AA_SEED_G___, // 64..71
    LEVEL_2_AA_SEED_H___,
    LEVEL_2_AA_SEED_VILM,
    LEVEL_2_AA_SEED_____,
    LEVEL_2_AA_SEED_QKR_,
    LEVEL_2_AA_SEED_VILM,
    LEVEL_2_AA_SEED_VILM,
    LEVEL_2_AA_SEED_N___,
    LEVEL_2_AA_SEED_____, // 72..79
    LEVEL_2_AA_SEED_P___,
    LEVEL_2_AA_SEED_QKR_,
    LEVEL_2_AA_SEED_QKR_,
    LEVEL_2_AA_SEED_TS__,
    LEVEL_2_AA_SEED_TS__,
    LEVEL_2_AA_SEED_____,
    LEVEL_2_AA_SEED_VILM,
    LEVEL_2_AA_SEED_WFY_, // 80..87
    LEVEL_2_AA_SEED_____,
    LEVEL_2_AA_SEED_WFY_,
    LEVEL_2_AA_SEED_____,
    LEVEL_2_AA_SEED_____,
    ...
    LEVEL_2_AA_SEED_____,
    LEVEL_2_AA_SEED_____,
    LEVEL_2_AA_SEED_____, // 248..255
];

const LEVEL_2_AA_SEED_C____RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
    0x4abe9962,
    0x957d32c4,
    0x12afa6588,
    0x55f4cb11,
...
const LEVEL_2_AA_SEED_C____LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
    0x1d07fd6400000000,
    0x3a0ffac800000000,
    0x741ff59000000000,
    0xe83feb2000000000,
...
const LEVEL_2_AA_SEED_G____RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
    0x9bdf4360,
    0x137be86c0,
    0x6f7d0d81,
    0xdefa1b02,
...
const LEVEL_2_AA_SEED_G____LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
    0xf59c509200000000,
    0xeb38a12600000000,
    0xd671424e00000000,
    0xace2849e00000000,
...
const LEVEL_2_AA_SEED_A____RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
    0xfe9c6c03,
    0x1fd38d806,
    0x1fa71b00d,
    0x1f4e3601b,
...
const LEVEL_2_AA_SEED_A____LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
    0x6f735c8200000000,
    0xdee6b90400000000,
    0xbdcd720a00000000,
    0x7b9ae41600000000,
...
const LEVEL_2_AA_SEED_TS___RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
    0x1a1dbc3b0,
    0x143b78761,
    0x876f0ec3,
    0x10ede1d86,
...
const LEVEL_2_AA_SEED_TS___LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
    0xe7392f0a00000000,
    0xce725e1600000000,
    0x9ce4bc2e00000000,
    0x39c9785e00000000,
...
const LEVEL_2_AA_SEED_N____RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
    0xd4b3961f,
    0x1a9672c3e,
    0x152ce587d,
    0xa59cb0fb,
...
const LEVEL_2_AA_SEED_N____LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
    0x956ddcfc00000000,
    0x2adbb9fa00000000,
    0x55b773f400000000,
    0xab6ee7e800000000,
...
const LEVEL_2_AA_SEED_DE___RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
    0x1ac4f5efa,
    0x1589ebdf5,
    0xb13d7beb,
    0x1627af7d6,
...
const LEVEL_2_AA_SEED_DE___LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
    0x4ec0ef1a00000000,
    0x9d81de3400000000,
    0x3b03bc6a00000000,
    0x760778d400000000,
...
const LEVEL_2_AA_SEED_QKR__RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
    0x11872ed78,
    0x30e5daf1,
    0x61cbb5e2,
    0xc3976bc4,
...
const LEVEL_2_AA_SEED_QKR__LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
    0x1cd6ca4800000000,
    0x39ad949000000000,
    0x735b292000000000,
    0xe6b6524000000000,
...
const LEVEL_2_AA_SEED_VILM_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
    0x94921035,
    0x12924206a,
    0x524840d5,
    0xa49081aa,
...
const LEVEL_2_AA_SEED_VILM_LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
    0x547ef17800000000,
    0xa8fde2f000000000,
    0x51fbc5e200000000,
    0xa3f78bc400000000,
...
const LEVEL_2_AA_SEED_WFY__RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
    0x1b87bf79f,
    0x170f7ef3f,
    0xe1efde7f,
    0x1c3dfbcfe,
...
const LEVEL_2_AA_SEED_WFY__LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
    0x419722ec00000000,
    0x832e45d800000000,
    0x65c8bb200000000,
    0xcb9176400000000,
...
const LEVEL_2_AA_SEED_H____RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
    0x1fdc32de1,
    0x1fb865bc3,
    0x1f70cb787,
    0x1ee196f0f,
...
const LEVEL_2_AA_SEED_H____LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
    0xdd5cce5a00000000,
    0xbab99cb600000000,
    0x7573396e00000000,
    0xeae672dc00000000,
...
const LEVEL_2_AA_SEED_P____RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
    0xc07d6598,
    0x180facb30,
    0x101f59661,
    0x3eb2cc3,
...
const LEVEL_2_AA_SEED_P____LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
    0x90e0c5e000000000,
    0x21c18bc200000000,
    0x4383178400000000,
    0x87062f0800000000,
...
const LEVEL_2_AA_SEED______RIGHT_33BITS_ROLL_TABLE: [u64; 33] = AA_SEED___RIGHT_33BITS_ROLL_TABLE;
const LEVEL_2_AA_SEED______LEFT_31BITS_ROLL_TABLE: [u64; 31] = AA_SEED___LEFT_31BITS_ROLL_TABLE;

const LEVEL_2_AA_SEED_RIGHT_33BITS_ROLL_TABLE: [&[u64; 33]; 256] = [
...
const LEVEL_2_AA_SEED_LEFT_31BITS_ROLL_TABLE: [&[u64; 31]; 256] = [
...
const LEVEL_3_AA_SEED_C___: u64 = 0x5713e4c10cebbfa3;
const LEVEL_3_AA_SEED_G___: u64 = 0xbe084b869537379b;
const LEVEL_3_AA_SEED_ATS_: u64 = 0x985fd9efa0fe5b82;
const LEVEL_3_AA_SEED_NDE_: u64 = 0x9aca6c4f4ef69df0;
const LEVEL_3_AA_SEED_QKR_: u64 = 0x917de473b721df0e;
const LEVEL_3_AA_SEED_VILM: u64 = 0x37cdd84aa07c5bd7;
const LEVEL_3_AA_SEED_WFY_: u64 = 0x51a7955f1a67a896;
const LEVEL_3_AA_SEED_H___: u64 = 0x1d2a0ba493708fbf;
const LEVEL_3_AA_SEED_P___: u64 = 0xfe4c47da16611245;
const LEVEL_3_AA_SEED_____: u64 = AA_SEED__;

const LEVEL_3_AA_SEED_TABLE: [u64; 256] = [
    LEVEL_3_AA_SEED_____,
    LEVEL_3_AA_SEED_____,
    LEVEL_3_AA_SEED_____,
    LEVEL_3_AA_SEED_____,
    LEVEL_3_AA_SEED_____,
    ...
    LEVEL_3_AA_SEED_____,
    LEVEL_3_AA_SEED_____,
    LEVEL_3_AA_SEED_____, // 56..63
    LEVEL_3_AA_SEED_____,
    LEVEL_3_AA_SEED_ATS_,
    LEVEL_3_AA_SEED_____,
    LEVEL_3_AA_SEED_C___,
    LEVEL_3_AA_SEED_NDE_,
    LEVEL_3_AA_SEED_NDE_,
    LEVEL_3_AA_SEED_WFY_,
    LEVEL_3_AA_SEED_G___, // 64..71
    LEVEL_3_AA_SEED_H___,
    LEVEL_3_AA_SEED_VILM,
    LEVEL_3_AA_SEED_____,
    LEVEL_3_AA_SEED_QKR_,
    LEVEL_3_AA_SEED_VILM,
    LEVEL_3_AA_SEED_VILM,
    LEVEL_3_AA_SEED_NDE_,
    LEVEL_3_AA_SEED_____, // 72..79
    LEVEL_3_AA_SEED_P___,
    LEVEL_3_AA_SEED_QKR_,
    LEVEL_3_AA_SEED_QKR_,
    LEVEL_3_AA_SEED_ATS_,
    LEVEL_3_AA_SEED_ATS_,
    ...
    LEVEL_3_AA_SEED_____,
    LEVEL_3_AA_SEED_____,
    LEVEL_3_AA_SEED_____, // 248..255
];

const LEVEL_3_AA_SEED_C____RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
    0x10cebbfa3,
    0x19d77f47,
    0x33aefe8e,
    0x675dfd1c,
...
const LEVEL_3_AA_SEED_C____LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
    0x5713e4c000000000,
    0xae27c98000000000,
    0x5c4f930200000000,
    0xb89f260400000000,
...
const LEVEL_3_AA_SEED_G____RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
    0x9537379b,
    0x12a6e6f36,
    0x54dcde6d,
    0xa9b9bcda,
...
const LEVEL_3_AA_SEED_G____LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
    0xbe084b8600000000,
    0x7c10970e00000000,
    0xf8212e1c00000000,
    0xf0425c3a00000000,
...
const LEVEL_3_AA_SEED_ATS__RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
    0x1a0fe5b82,
    0x141fcb705,
    0x83f96e0b,
    0x107f2dc16,
...
const LEVEL_3_AA_SEED_ATS__LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
    0x985fd9ee00000000,
    0x30bfb3de00000000,
    0x617f67bc00000000,
    0xc2fecf7800000000,
...
const LEVEL_3_AA_SEED_NDE__RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
    0x14ef69df0,
    0x9ded3be1,
    0x13bda77c2,
    0x77b4ef85,
...
const LEVEL_3_AA_SEED_NDE__LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
    0x9aca6c4e00000000,
    0x3594d89e00000000,
    0x6b29b13c00000000,
    0xd653627800000000,
...
const LEVEL_3_AA_SEED_QKR__RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
    0x1b721df0e,
    0x16e43be1d,
    0xdc877c3b,
    0x1b90ef876,
...
const LEVEL_3_AA_SEED_QKR__LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
    0x917de47200000000,
    0x22fbc8e600000000,
    0x45f791cc00000000,
    0x8bef239800000000,
...
const LEVEL_3_AA_SEED_VILM_RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
    0xa07c5bd7,
    0x140f8b7ae,
    0x81f16f5d,
    0x103e2deba,
...
const LEVEL_3_AA_SEED_VILM_LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
    0x37cdd84a00000000,
    0x6f9bb09400000000,
    0xdf37612800000000,
    0xbe6ec25200000000,
...
const LEVEL_3_AA_SEED_WFY__RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
    0x11a67a896,
    0x34cf512d,
    0x699ea25a,
    0xd33d44b4,
...
const LEVEL_3_AA_SEED_WFY__LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
    0x51a7955e00000000,
    0xa34f2abc00000000,
    0x469e557a00000000,
    0x8d3caaf400000000,
...
const LEVEL_3_AA_SEED_H____RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
    0x93708fbf,
    0x126e11f7e,
    0x4dc23efd,
    0x9b847dfa,
...
const LEVEL_3_AA_SEED_H____LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
    0x1d2a0ba400000000,
    0x3a54174800000000,
    0x74a82e9000000000,
    0xe9505d2000000000,
...
const LEVEL_3_AA_SEED_P____RIGHT_33BITS_ROLL_TABLE: [u64; 33] = [
    0x16611245,
    0x2cc2248a,
    0x59844914,
    0xb3089228,
...
const LEVEL_3_AA_SEED_P____LEFT_31BITS_ROLL_TABLE: [u64; 31] = [
    0xfe4c47da00000000,
    0xfc988fb600000000,
    0xf9311f6e00000000,
    0xf2623ede00000000,
...
const LEVEL_3_AA_SEED______RIGHT_33BITS_ROLL_TABLE: [u64; 33] = AA_SEED___RIGHT_33BITS_ROLL_TABLE;
const LEVEL_3_AA_SEED______LEFT_31BITS_ROLL_TABLE: [u64; 31] = AA_SEED___LEFT_31BITS_ROLL_TABLE;

const LEVEL_3_AA_SEED_RIGHT_33BITS_ROLL_TABLE: [&[u64; 33]; 256] = [
...
const LEVEL_3_AA_SEED_LEFT_31BITS_ROLL_TABLE: [&[u64; 31]; 256] = [
